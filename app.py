...
daemons = [
    ...
    },
    {
        ...
        "description": "O Duque Agreas, também conhecido como Agares, é o Segundo Espírito e está subordinado ao poder do Oriente. Quando se manifesta, assume a forma de um homem de meia-idade, atraente, montado em um dragão e segurando um açor em sua mão, apesar do qual, a sua aparência é tranquila. Agares é descrito como tendo a habilidade de dar um impulso poderoso àqueles que estão estagnados ou parados, concedendo-lhes a energia necessária para que possam avançar em suas metas e objetivos. Sua influência também se estende àqueles que fugiram, permitindo que ele possa ajudar no retorno de indivíduos que, por algum motivo, tenham ido embora. Além de sua capacidade de motivar e encorajar, Agares possui outra habilidade surpreendente: ele é capaz de facilitar o aprendizado de qualquer língua ou idioma existente. Isso não está limitado só a parte do aprendizado de idiomas, já que com sua vasta compreensão das linguagens e do mundo, Agares é capaz de conceder aos indivíduos a capacidade de se comunicar e se entender com pessoas de outras culturas e nacionalidades, que poderiam ter sido inacessíveis de outra forma. Essa habilidade é valiosa para aqueles que viajam para o exterior, estudantes de línguas ou profissionais que precisam se comunicar e entender a cultura de pessoas de outras nacionalidades. Aqueles que invocam Agares também podem contar com seu poder para destruir dignidades espirituais e temporais e até mesmo causar destruição (o que no texto é chamado de “terremotos”). No entanto, essa influência pode ser perigosa e deve ser utilizada com cuidado e responsabilidade, pelos possíveis retornos que pode ter. Anteriormente, fazia parte da Ordem das Virtudes. Agora governa 31 legiões de espíritos, o que o torna um líder poderoso e influente dentro da hierarquia dos senhores antigos, tanto pelo número de subordinados quanto pela sua origem angelical.",
        "planet": "Vênus",
        "direction": "Norte",
